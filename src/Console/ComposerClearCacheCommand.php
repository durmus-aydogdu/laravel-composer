...
class ComposerClearCacheCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'composer:clear-cache';
    ...
    /**
     * Clear all content from Composer's cache directories
     *
     * @return void
     */
    public function clearCache()
    {
        $this->info("Starting clear cache");

        $process = $this->getProcess();

        $process->setCommandLine(trim($this->findComposer().' clear-cache'));
